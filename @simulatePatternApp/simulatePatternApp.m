classdef simulatePatternApp < handle
    ...
    methods (Static)
        function simParameter = initParameter(app)
            ...
            simParameter.YData = 6 * ( [-0.5*simParameter.nPixel(1),...
                0.5*simParameter.nPixel(1)] );
            simParameter.XData = 6 * ( [-0.5*simParameter.nPixel(2),...
                0.5*simParameter.nPixel(2)] );
    ...
    methods (Access = private)
        ...
        function app = updateParameter(app,src,evt)
            ...
            app.simParameter.YData = 6 * ( [-0.5,0.5]*...
                app.simParameter.nPixel(1) + [0,1] );
            app.simParameter.XData = 6 * ( [-0.5,0.5]*...
                app.simParameter.nPixel(2) + [0,1] );
