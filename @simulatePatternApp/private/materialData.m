...
material(1).scatteringDensity = sqrt(material(1).f1.^2+material(1).f2.^2)*material(1).particleDensity;
...
material(2).scatteringDensity = sqrt(material(2).f1.^2+material(2).f2.^2)*material(2).particleDensity;
...
material(3).scatteringDensity = sqrt(material(3).f1.^2+material(3).f2.^2)*material(3).particleDensity;


fprintf('scattering densities:\n He: %.3g\n Xe: %.3g\n Ag: %.3g\n', material(1).scatteringDensity, material(2).scatteringDensity, material(3).scatteringDensity)
fprintf('scattering ratios:\n He: %.3g\n Xe: %.3g\n Ag: %.3g\n', 1, material(2).scatteringDensity/material(1).scatteringDensity, material(3).scatteringDensity/material(1).scatteringDensity)
